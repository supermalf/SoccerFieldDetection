 ...
 * $Id: im_format_all.h,v 1.6 2005/04/18 21:41:41 scuri Exp $
 */
 ...
 * \par
 * Access to the TIFF file format uses libTIFF version 3.7.2 \n
...
\verbatim
    ...
    Comments:
      ...
      Must define in the makefile: JPEG_SUPPORT, ZIP_SUPPORT, PIXARLOG_SUPPORT, OJPEG_SUPPORT.
      Changed "tiff_jpeg.c" - commented "downsampled_output = TRUE" in 2 places.
      Fixed "tiff_ojpeg.c" for boolean type compilation. 
      New file tiff_binfile.c
      Changed tif_config.h to match our needs.
\endverbatim
 * \ingroup format */
